...
export const financeArticle: Article = {
  id: 'finance-ai-chatbots',
  title: 'AI Chatbots in Finance: ROI, Market Outlook, and Strategic Imperatives',
  slug: 'finance-ai-chatbots-roi-market-outlook',
...
`,
  tags: ['finance', 'banking', 'ai-chatbots', 'generative-ai', 'roi'],
  ...
  seo: {
    ...
    keywords: ['finance', 'banking', 'chatbots', 'AI ROI', 'BFSI', 'automation', 'Sajedar', 'business automation', 'ai chatbots', 'chatbots for finance', 'ai powered sales']
  },
