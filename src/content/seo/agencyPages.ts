...
export const coreServicePages: SeoPageLink[] = [
  ...
  },
  {
    ...
    href: '/messenger-marketing-agency',
...
export const useCasePages: SeoPageLink[] = [
  ...
  },
  {
    ...
    href: '/abandoned-cart-messenger-automation',
...
export const proofPages: SeoPageLink[] = [
  {
    title: 'Case Studies',
    href: '/case-studies',
    description: 'Real implementation breakdowns and business results.',
  },
  {
    title: 'Live Demo',
    href: '/demo',
    description: 'See how automation flows work in an interactive demo.',
  },
  {
    title: 'Contact Team',
    href: '/contact',
    description: 'Request a scoped automation plan for your team.',
  },
];

export const ecommerceSupportingArticleSlugs = [
  'conversion-rate-improvement-messenger',
  'messenger-abandoned-cart-recovery-stats',
  'chatbot-product-recommendations-examples',
  'messenger-remarketing-strategy',
  'conversational-checkout-benefits',
];
