      ...
      <div className="max-w-6xl w-full mx-auto flex flex-col gap-16">
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-emerald-900/20 to-transparent border border-emerald-500/30 rounded-xl p-6 backdrop-blur-sm">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Personality Customization</h3>
                  <p className="text-gray-300">Define your chatbot's character - friendly, professional, witty, or formal. Create a unique personality that resonates with your target audience.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-900/20 to-transparent border border-emerald-500/30 rounded-xl p-6 backdrop-blur-sm">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Tone & Style Matching</h3>
                  <p className="text-gray-300">Match your brand's communication style - casual and approachable, or sophisticated and authoritative. Perfect alignment with your brand guidelines.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-900/20 to-transparent border border-emerald-500/30 rounded-xl p-6 backdrop-blur-sm">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Industry-Specific Language</h3>
                  <p className="text-gray-300">Use industry-specific terminology, jargon, and communication patterns. Your chatbot speaks the language your customers expect and understand.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-900/20 to-transparent border border-emerald-500/30 rounded-xl p-6 backdrop-blur-sm">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Dynamic Adaptation</h3>
                  <p className="text-gray-300">Your chatbot adapts its communication style based on customer context, mood, and interaction history for personalized experiences.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 border border-purple-500/30 rounded-xl p-8 backdrop-blur-sm">
            <h3 className="text-2xl font-bold text-white mb-4">Ready to Create Your Perfect Brand Voice?</h3>
