      ...
      <div className="max-w-6xl w-full mx-auto flex flex-col gap-16">
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <p className="text-lg md:text-2xl text-gray-200 max-w-3xl mb-6">
            ...
            when your chatbot needs human intervention. Seamless handoff ensures customer satisfaction.
          </p>
        </div>
            ...
            <div className="bg-gradient-to-r from-emerald-900/20 to-transparent border border-emerald-500/30 rounded-xl p-6 backdrop-blur-sm">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Automatic escalation when chatbot confidence is low, complex queries detected, or customer requests human assistance.</p>
                </div>
              </div>
            </div>
