    ...
    <section className="w-full bg-[#18181b] py-16 px-4 flex flex-col items-center border-t border-white/10">
      <div className="max-w-6xl w-full mx-auto">
        ...
        <div className="flex flex-col items-center text-center gap-4 mb-12">
          ...
          >
            <span className="text-gray-400">Powerful Features</span> <span className="bg-gradient-to-r from-emerald-400 to-emerald-600 bg-clip-text text-transparent">for Your Business</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center hover:bg-white/10 transition-all duration-300">
            ...
            >
              Give your chatbot a unique brand identity with custom tone and style.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center hover:bg-white/10 transition-all duration-300">
            ...
            <p 
              ...
              style={{ fontFamily: 'SF Pro Text, -apple-system, BlinkMacSystemFont, sans-serif' }}
            >
              Feed your chatbot verified business data to make it an expert on your brand.
            </p>
          </div>

          {/* Business Management */}
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center hover:bg-white/10 transition-all duration-300">
            <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-full flex items-center justify-center">
