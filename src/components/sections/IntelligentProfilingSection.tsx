      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-20 px-6 py-28 md:py-36">
        <div className="relative flex flex-col md:flex-row md:items-center md:justify-between w-full">
          ...
          <div className="mt-12 md:mt-0 md:ml-0 w-full max-w-md">
            <div className="relative overflow-hidden border-0 bg-white shadow-xl rounded-3xl border border-stone-200">
              ...
              <div className="relative flex flex-col gap-6 p-8 z-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-[#57534e]">
                  <div className="flex items-center gap-2 bg-stone-50 rounded-xl px-3 py-2 shadow-sm border border-stone-200 min-w-0">
                ...
                <div className="mt-6 border-t border-stone-200 pt-4 text-xs text-[#57534e]">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 bg-stone-50 rounded-xl px-3 py-2 shadow-sm border border-stone-200"><span className="text-lg">🛒</span> Browsed kitchen appliances - Today</li>
                    <li className="flex items-center gap-2 bg-stone-50 rounded-xl px-3 py-2 shadow-sm border border-stone-200"><span className="text-lg">👟</span> Added sneakers to wishlist - 2 days ago</li>
                    <li className="flex items-center gap-2 bg-stone-50 rounded-xl px-3 py-2 shadow-sm border border-stone-200"><span className="text-lg">🪴</span> Viewed home décor sale - 1 week ago</li>
                  </ul>
                </div>
              </div>
            </div>
