      ...
      <div className="max-w-6xl w-full mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white/60 backdrop-blur-sm border border-stone-200 rounded-2xl p-6 text-center hover:bg-white/80 transition-all duration-300 shadow-sm">
            ...
            <h3
              className="text-lg font-semibold text-[#292524] mb-2"
              style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, sans-serif' }}
            >
              Facebook
            </h3>
          ...
          <div className="bg-white/60 backdrop-blur-sm border border-stone-200 rounded-2xl p-6 text-center hover:bg-white/80 transition-all duration-300 shadow-sm">
            <div className="w-12 h-12 mx-auto mb-4 bg-green-600 rounded-2xl flex items-center justify-center">
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19.5 3h-15A1.5 1.5 0 0 0 3 4.5v15A1.5 1.5 0 0 0 4.5 21h15a1.5 1.5 0 0 0 1.5-1.5v-15A1.5 1.5 0 0 0 19.5 3zM9 19H5v-4h4v4zm6 0h-4v-4h4v4zm6 0h-4v-4h4v4zM9 13H5V9h4v4zm6 0h-4V9h4v4zM9 7H5V3h4v4zm6 0h-4V3h4v4z" />
              </svg>
            </div>
            <h3
              className="text-lg font-semibold text-[#292524] mb-2"
