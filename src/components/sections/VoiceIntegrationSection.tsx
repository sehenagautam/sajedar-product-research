      ...
      <div className="max-w-6xl w-full mx-auto flex flex-col gap-16">
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <h2 className="text-5xl md:text-6xl font-serif font-bold text-white mb-2 leading-tight tracking-tight">
            <span className="text-emerald-500">Voice Integration</span> for Natural Conversations
          </h2>
          ...
          <div className="relative">
              ...
              <div className="bg-gradient-to-r from-emerald-500 to-teal-600 px-4 py-3 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-emerald-100">Voice Enabled • Multi-Modal</div>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                  <span className="text-xs text-emerald-100">Listening</span>
                </div>
              </div>
                ...
                <div className="flex-1 space-y-4 overflow-y-auto">
                  ...
                  <div className="flex justify-end">
                    <div className="bg-emerald-500 text-white rounded-lg px-4 py-2 max-w-xs">
                      ...
                      <span className="text-xs text-emerald-100 block mt-1">2:30 PM</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <div className="bg-emerald-500 text-white rounded-lg px-4 py-2 max-w-xs">
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <span className="text-xs text-emerald-200">Voice Message</span>
                      </div>
                      <span className="text-xs text-emerald-100 block mt-1">2:30 PM</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <div className="bg-emerald-500 text-white rounded-lg px-4 py-2 max-w-xs">
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <span className="text-xs text-emerald-200">Voice Command</span>
                      </div>
                      <span className="text-xs text-emerald-100 block mt-1">2:31 PM</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <div className="bg-emerald-500 text-white rounded-lg px-4 py-2 max-w-xs">
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <span className="text-xs text-emerald-200">Voice Query</span>
                      </div>
                      <span className="text-xs text-emerald-100 block mt-1">2:32 PM</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-start">
                    <div className="bg-white text-gray-800 rounded-lg px-4 py-2 max-w-xs shadow-sm">
                      ...
                      <div className="mt-2 space-y-1">
                        <button className="w-full bg-emerald-500 text-white px-3 py-1 rounded text-xs hover:bg-emerald-600 transition">
            ...
            <div className="absolute -top-8 -right-8 space-y-2">
              ...
              <div className="bg-white rounded-lg p-3 shadow-lg border-l-4 border-emerald-500 max-w-xs">
                <div className="text-xs text-emerald-600 font-medium mb-1">Voice Recognition</div>
                <p className="text-xs text-gray-700">99% Accuracy • 5 Languages</p>
              </div>

              {/* Voice Commands */}
              <div className="bg-white rounded-lg p-3 shadow-lg border-l-4 border-emerald-500 max-w-xs">
                <div className="text-xs text-emerald-600 font-medium mb-1">Voice Commands</div>
