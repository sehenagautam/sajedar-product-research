  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex justify-center items-center relative">
      ...
      <svg viewBox="0 0 1100 400" width="100%" height="400" className="block mx-auto" style={{ maxWidth: 1100 }}>
        ...
        <rect x="60" y="70" width="160" height="80" rx="16" fill="#23243a" stroke="#b6c6e3" strokeWidth="2" />
        ...
        {/* Connecting lines */}
        <line x1="220" y1="110" x2="320" y2="110" stroke="#64748b" strokeWidth="3" />
        ...
        <text x="140" y="130" fontSize="16" fill="#fff" textAnchor="middle">Potential Customer</text>
        ...
        <text x="890" y="130" fontSize="16" fill="#fff" textAnchor="middle">Final response</text>
        ...
        <text x="200" y="318" fontSize="14" fill="#fff" textAnchor="middle">Open AI</text>
        <text x="340" y="318" fontSize="14" fill="#fff" textAnchor="middle">Memory</text>
        <text x="480" y="318" fontSize="14" fill="#fff" textAnchor="middle">Database</text>
        <text x="620" y="318" fontSize="14" fill="#fff" textAnchor="middle">SQL</text>
        <text x="760" y="318" fontSize="14" fill="#fff" textAnchor="middle">CRM</text>
