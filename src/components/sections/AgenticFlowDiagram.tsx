  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex justify-center items-center relative">
      ...
      <svg viewBox="0 0 1100 400" width="100%" height="400" className="block mx-auto" style={{ maxWidth: 1100 }}>
        ...
        {/* Sajedar AI icon above label, both above box */}
        <text x="410" y="54" fontSize="32" fontFamily="monospace" textAnchor="middle">✨</text>
        <text x="410" y="74" fontSize="16" fill="#10b981" fontWeight="bold" textAnchor="middle">Sajedar AI</text>
        ...
        <text x="200" y="318" fontSize="14" fill="#44403c" textAnchor="middle">Open AI</text>
        <text x="340" y="318" fontSize="14" fill="#44403c" textAnchor="middle">Memory</text>
        <text x="480" y="318" fontSize="14" fill="#44403c" textAnchor="middle">Database</text>
        <text x="620" y="318" fontSize="14" fill="#44403c" textAnchor="middle">CDN</text>
        <text x="760" y="318" fontSize="14" fill="#44403c" textAnchor="middle">CRM</text>
        <text x="900" y="318" fontSize="14" fill="#10b981" textAnchor="middle">Call another Agent</text>
